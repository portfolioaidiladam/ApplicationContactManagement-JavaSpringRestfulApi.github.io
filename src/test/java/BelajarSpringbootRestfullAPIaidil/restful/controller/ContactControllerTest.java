...
import BelajarSpringbootRestfullAPIaidil.restful.model.ContactResponse;
...
import BelajarSpringbootRestfullAPIaidil.restful.repository.UserRepository;
import BelajarSpringbootRestfullAPIaidil.restful.security.BCrypt;
...
import BelajarSpringbootRestfullAPIaidil.restful.model.CreateContactRequest;
import BelajarSpringbootRestfullAPIaidil.restful.model.UpdateContactRequest;
...
class ContactControllerTest {
    ...
    void createContactSuccess() throws Exception {
        CreateContactRequest request = new CreateContactRequest();
        request.setFirstName("Aidil");
        request.setLastName("Adam");
        request.setEmail("aidil@example.com");
        ...
        mockMvc.perform(
            ...
            assertEquals("Aidil", response.getData().getFirstName());
            assertEquals("Adam", response.getData().getLastName());
            assertEquals("aidil@example.com", response.getData().getEmail());
